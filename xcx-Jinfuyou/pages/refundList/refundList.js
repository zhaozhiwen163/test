...
refundFn:function(){
  ...
  var sign = util.hexMD5('clientId=' + wxData.clientId + '&companyId=' + gConfig.companyId + '&orderId=0' + '&pageNum=1' + '&sdate=0' + '&status=' + status + gConfig.key)
   wx.request({
     url: gConfig.http + 'channel/xcx/refund/order',
     data:{
